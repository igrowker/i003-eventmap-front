...
export type FilterByDateProps = { onDateRangeChange?: () => void, filterValueState: { filterValues: FilterValues, setFilterValues: (value: Filters) => void }, setIsFilterMenuOpen: (value: boolean) => void }
