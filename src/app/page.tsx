...
import MediaCard from "@/components/CardEventsHome/CardEventsHome";
...
export default function Home() {
  return (
    <main className=" bg-bgHome flex min-h-screen flex-col items-center p-5 relative">
      <header className="flex sm:max-w-sm">
        <Header/>
      </header>
